  ...
  try {
    ...
    if (!edition) {
      return res.status(400).json({
        code: 400,
        status: "Error",
        message: "Missing hadith parameter. Use '/editionLanguage-editionName' to get a hadith",
      });
    }
    ...
    if (!editionLanguage || !editionName) {
      return res.status(400).json({
        code: 400,
        status: "Error",
        message: "Invalid hadith format. Use 'editionLanguage-editionName' to get a hadith",
      });
    }
  ...
  try {
    ...
    if (!edition) {
      return res.status(400).json({
        code: 400,
        status: "Error",
        message: "Missing hadith parameter. Use '/editionLanguage-editionName' to get a section",
      });
    }
    ...
    if (!editionLanguage || !editionName) {
      return res.status(400).json({
        code: 400,
        status: "Error",
        message: "Invalid hadith format. Use 'editionLanguage-editionName' to get a section",
      });
    }
